        ...
        <div className="container-custom px-4 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-white/60">
              {"Inscrivez-vous dès maintenant et obtenez votre permis bateau à Metz."}
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-6">
              {"Centre de formation agréé pour le permis bateau à Metz. Formations côtier, fluvial et hauturier sur la Moselle."}
            </p>
            <div className="flex gap-3">
              <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" /></svg>
              </a>
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><rect x="2" y="2" width="20" height="20" rx="5" strokeWidth="2" /><circle cx="12" cy="12" r="5" strokeWidth="2" /><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor" /></svg>
              </a>
            </div>
          </div>
          ...
          {/* Col 2: Formations */}
          <div>
            <h4 className="font-heading font-bold text-sm uppercase tracking-wider mb-6">Formations</h4>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start gap-3">
                ...
                <span className="text-white/50">Port de Plaisance<br />57000 Metz</span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+33387000000" className="text-white/50 hover:text-white transition-colors">03 87 00 00 00</a>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-ocean-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                <span className="text-white/50">Lun-Ven : 9h-19h<br />Sam : 9h-17h</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-custom px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-sm">
            &copy; {new Date().getFullYear()} Permis Bateau Metz. Tous droits réservés.
          </p>
          <p className="text-white/30 text-xs">
            {"Centre agréé • Formation permis plaisance • Metz, Moselle (57)"}
          </p>
        </div>
      </div>
    </footer>
